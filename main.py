...
def main():
    ...
    arg_parser.add_argument("--lr", type=float, default=0.001)#0.001
    ...
    arg_parser.add_argument('--dropout_keep_probs', nargs='?', default="[0.6, 0.6, 1]")
    ...
    arg_parser.add_argument("--input_trans_size", type=int, default=200)
    arg_parser.add_argument("--batch_size", type=int, default=32)
    arg_parser.add_argument("--select_index", type=int, default=[0, 1, 2])#选择的项 有效信息项
    arg_parser.add_argument('--num_epochs', type=int, default=20)#default=150
    arg_parser.add_argument('--n_hop', type=int, default=3)
    arg_parser.add_argument('--skill_neighbor_num', type=int, default=10)#default=10
    arg_parser.add_argument('--question_question_neighbor_num', type=int, default=3)
    ...
    arg_parser.add_argument('--hist_neighbor_num', type=int, default=1)  # history neighbor num
    arg_parser.add_argument('--next_neighbor_num', type=int, default=4)  # next neighbor num=4.
    arg_parser.add_argument('--yvzhi', type=int, default=0.98)
    ...
    fileObject.write(jsObj)#存储当此实验数据
    fileObject.close()
    print(config)
